...
@NgModule({
  imports: [
    ...
    DropdownModule // 这个是�, ModelplanComponent�选下拉框
  ],
  declarations: [ProductionplanComponent,ProductionplancellComponent, CfmoveplanComponent,ModelplanComponent,ArbankcellinplanComponent],
