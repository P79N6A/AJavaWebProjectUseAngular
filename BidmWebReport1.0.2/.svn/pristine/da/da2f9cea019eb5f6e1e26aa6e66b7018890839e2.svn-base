export class sum_wip_cell_both{
    "Key" = "SUM";
    "CutP" = "";
    "CT" = "";
    "Trim" = "";
    ...
    "Packing" = "";
    "SUM" = "";
  public setProperty(indexact:number,propertyValue:any):void{
    if(indexact == 1){
